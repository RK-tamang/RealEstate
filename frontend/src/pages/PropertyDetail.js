            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-gray-500">Est. ${Math.round(property.price / property.area)}/sq ft</p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <a href={`tel:${property.agent.phone}`} className="flex items-center text-gray-600 hover:text-primary-600">
                    <PhoneIcon className="h-5 w-5 mr-2" />
                    <span>{property.agent.phone}</span>
                  </a>
                  <a href={`mailto:${property.agent.email}`} className="flex items-center text-gray-600 hover:text-primary-600">
