  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 items-center min-h-[90vh] gap-12 relative z-10">
    ...
    <div className="space-y-6 pt-16 md:pt-0 max-w-xl z-20 relative text-white">
      <h1 className="text-4xl sm:text-5xl font-bold leading-tight">
        The <span className="text-yellow-400">#1 site</span> real estate<br />
        professionals trust*
      </h1>
      <p className="text-gray-300 max-w-md">
        From as low as $10 per day with limited time offer discounts.
      </p>
      <a href="#properties" className="inline-block text-sm font-medium text-yellow-400 hover:underline">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Search through our extensive collection of properties</p>
          </div>
          <SearchBar />
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Handpicked properties just for you</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">We make finding your dream home simple and enjoyable</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Find properties quickly with our advanced search filters</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Get help from our experienced real estate professionals</p>
            </div>
          </div>
        </div>
      </section>
